          ...
          >
            <div className="invest-wrap ">
              ...
              >
                ...
                {/* Tabs */}
                <div className="d-flex mb-4 rounded-pill overflow-hidden">
                  <button
                    className="flex-fill py-2 fw-medium text-sm"
                    style={{
                      flex: 1,
                      backgroundColor:
                        activeTab === "direct"
                          ? "#1b57beff"
                          : "rgba(26, 33, 210, 0.4)",
                      color: activeTab === "direct" ? "#fff" : "#ccc",
                      border: "none",
                      transition: "0.3s",
                    }}
                    ...
                    style={{
                      ...
                      backgroundColor:
                        activeTab === "missions"
                          ? "#1b57beff"
                          : "rgba(26, 33, 210, 0.4)",
                      color: activeTab === "missions" ? "#fff" : "#ccc",
                      border: "none",
                      transition: "0.3s",
                    }}
                ...
                <div className="d-flex flex-column gap-3">
                  {currentData.map((reward, index) => {
                    const progress = (reward.current / reward.total) * 100;
                    ...
                    return (
                      <div
                        ...
                        style={{
                          backgroundColor: "rgba(26, 33, 210, 0.4)",
...
export default InvitationRewardNew;

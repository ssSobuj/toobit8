...
const ModifyLoginPassword = () => {
  ...
  const handleLogginPass = () => {
    setShowLogginPass(!showLogginPass);
  };
  const handleNewPass = () => {
  ...
  return (
    <div id="app" data-v-app="" className="a-t-30 no-1">
      ...
      <div className="van-config-provider">
        ...
        >
          <SingleHeader pageName={t("modify_login_password")}></SingleHeader>
              ...
              <form data-v-76442317 onSubmit={handleSubmit}>
                <div data-v-76442317 className="base-input is-password">
                  <div className="input-box">
                    ...
                    <input
                      autoComplete="off"
                      placeholder={t("old_login_password")}
                      className="w-full"
                ...
                <div data-v-76442317 className="base-input is-password">
                  <div className="input-box">
                    ...
                    <input
                      autoComplete="off"
                      placeholder={t("new_login_password")}
                      className="w-full"
